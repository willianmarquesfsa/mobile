...
import { Body, Text, ListItem, Left} from 'native-base';
...
<View style={{backgroundColor: '#1A2D3C', borderRadius: windowWidth*0.042}}>
  <ListItem  icon onPress={() => this.props.navigation.navigate('Todos2')}>
    ...
    <Body><Text  style={{color: '#F0F0F2',fontSize: windowWidth*0.042,fontFamily: 'Inter-Black'}}>Todos</Text></Body>
  </ListItem>
  <ListItem icon onPress={() => this.props.navigation.navigate('Acessorios/Diversos2')}>
    <Left><FontAwesome5 name="eye" size={windowWidth*0.045} color='#FCAD02' /></Left>
    <Body><Text  style={{color: '#F0F0F2',fontSize: windowWidth*0.042,fontFamily: 'Inter-Black'}}>AcessoriosDiversos</Text></Body>
  </ListItem>
  <ListItem icon onPress={() => this.props.navigation.navigate('Beleza2')}>
    <Left><FontAwesome5 name="eye" size={windowWidth*0.045} color='#FCAD02'/></Left>
    <Body><Text  style={{color: '#F0F0F2',fontSize: windowWidth*0.042,fontFamily: 'Inter-Black'}}>Beleza</Text></Body>
  </ListItem>
  <ListItem icon onPress={() => this.props.navigation.navigate('Casa & Jardin2')}>
    <Left><FontAwesome5 name="eye" size={windowWidth*0.045} color='#FCAD02' /></Left>
    <Body><Text  style={{color: '#F0F0F2', fontSize: windowWidth*0.042,fontFamily: 'Inter-Black'}}>Casa & Jardin</Text></Body>
  </ListItem>
  
  <ListItem icon onPress={() => this.props.navigation.navigate('Eletronicos2')}>
    <Left><FontAwesome5 name="eye" size={windowWidth*0.045} color='#FCAD02' /></Left>
    <Body><Text  style={{color: '#F0F0F2',fontSize: windowWidth*0.042,fontFamily: 'Inter-Black'}}>Eletronicos</Text></Body>
  </ListItem>
  <ListItem icon onPress={() => this.props.navigation.navigate('Moda Masculina2')}>
    <Left><FontAwesome5 name="eye" size={windowWidth*0.045} color='#FCAD02'/></Left>
    <Body><Text  style={{color: '#F0F0F2',fontSize: windowWidth*0.042,fontFamily: 'Inter-Black'}}>Moda Masculina</Text></Body>
  </ListItem>
...
<View style={{backgroundColor: '#203242', borderRadius: windowWidth*0.045}}>
...
render() {
  ...
  return (
    <View style={{backgroundColor: '#1A2D3C', borderRadius: windowWidth*0.045}}>
...
<View style={{backgroundColor: '#203242', borderRadius: windowWidth*0.042}}>
...
<View style={{backgroundColor: '#203242', borderRadius: windowWidth*0.045}}>
  <ListItem  icon onPress={() => this.props.navigation.navigate('Agro e PetShps')}>
   ...
   <ListItem  icon onPress={() => this.props.navigation.navigate('Hospedagem')}>
    <Left><FontAwesome5 name="eye" size={windowWidth*0.045} color='#FCAD02' /></Left>
    <Body ><Text style={{color: '#F0F0F2', fontSize: windowWidth*0.042,fontFamily: 'Inter-Black'}} >Hospedagem</Text></Body>
  </ListItem>
  <ListItem  icon onPress={() => this.props.navigation.navigate('Nutrição e Estetica animal')}>
    <Left><FontAwesome5 name="eye" size={windowWidth*0.045} color='#FCAD02' /></Left>
    <Body ><Text style={{color: '#F0F0F2', fontSize: windowWidth*0.042,fontFamily: 'Inter-Black'}} >Nutrição e Estetica animal</Text></Body>
  </ListItem>
  <ListItem icon onPress={() => this.props.navigation.navigate('Veterinaria')}>
    <Left><FontAwesome5 name="eye" size={windowWidth*0.045} color='#FCAD02'/></Left>
    <Body><Text  style={{color: '#F0F0F2', fontSize: windowWidth*0.042,fontFamily: 'Inter-Black'}}>Veterinaria</Text></Body>
  </ListItem>
  </View>
  )
  }
  ...
  <ListItem  icon onPress={() => this.props.navigation.navigate('Locação e seguros')}>
    <Left><FontAwesome5 name="eye" size={windowWidth*0.045} color='#FCAD02' /></Left>
    <Body ><Text style={{color: '#F0F0F2', fontSize: windowWidth*0.042,fontFamily: 'Inter-Black'}} >Locação e Seguros</Text></Body>
  </ListItem>
  <ListItem  icon onPress={() => this.props.navigation.navigate('Chaparia e Pintura')}>
    <Left><FontAwesome5 name="eye" size={windowWidth*0.045} color='#FCAD02' /></Left>
    <Body ><Text style={{color: '#F0F0F2', fontSize: windowWidth*0.042,fontFamily: 'Inter-Black'}} >Chaparia e Pintura</Text></Body>
  </ListItem>
  <ListItem  icon onPress={() => this.props.navigation.navigate('Mecanica e Eletrica')}>
    <Left><FontAwesome5 name="eye" size={windowWidth*0.045} color='#FCAD02' /></Left>
    <Body ><Text style={{color: '#F0F0F2', fontSize: windowWidth*0.042,fontFamily: 'Inter-Black'}} >Mecanica e Eletrica</Text></Body>
  </ListItem>
  <ListItem  icon onPress={() => this.props.navigation.navigate('Lavagem')}>
    <Left><FontAwesome5 name="eye" size={windowWidth*0.045} color='#FCAD02' /></Left>
    <Body ><Text style={{color: '#F0F0F2', fontSize: windowWidth*0.042,fontFamily: 'Inter-Black'}} >Lavagem</Text></Body>
  </ListItem>
  </View>
  ...
  <ListItem  icon onPress={() => this.props.navigation.navigate('Empreiteiras')}>
    <Left><FontAwesome5 name="eye" size={windowWidth*0.045} color='#FCAD02' /></Left>
    <Body ><Text style={{color: '#F0F0F2', fontSize: windowWidth*0.042,fontFamily: 'Inter-Black'}} >Empreiteiras</Text></Body>
  </ListItem>
  <ListItem  icon onPress={() => this.props.navigation.navigate('Móveis Portões e Vidros Planejados')}>
    <Left><FontAwesome5 name="eye" size={windowWidth*0.045} color='#FCAD02' /></Left>
    <Body ><Text style={{color: '#F0F0F2', fontSize: windowWidth*0.042,fontFamily: 'Inter-Black'}} >Móveis Portões e Vidros Planejados</Text></Body>
  </ListItem>
  <ListItem  icon onPress={() => this.props.navigation.navigate('Engenharia e Arquitetura')}>
    <Left><FontAwesome5 name="eye" size={windowWidth*0.045} color='#FCAD02' /></Left>
    <Body ><Text style={{color: '#F0F0F2', fontSize: windowWidth*0.042,fontFamily: 'Inter-Black'}} >Engenharia e Arquitetura</Text></Body>
  </ListItem>
  ...
  <ListItem  icon onPress={() => this.props.navigation.navigate('Ensino Superior')}>
    <Left><FontAwesome5 name="eye" size={windowWidth*0.045} color='#FCAD02' /></Left>
    <Body ><Text style={{color: '#F0F0F2', fontSize: windowWidth*0.042,fontFamily: 'Inter-Black'}} >Ensino Superior</Text></Body>
  </ListItem>
  <ListItem  icon onPress={() => this.props.navigation.navigate('Cursos Livres e Profissionalizantes')}>
    <Left><FontAwesome5 name="eye" size={windowWidth*0.045} color='#FCAD02' /></Left>
    <Body ><Text style={{color: '#F0F0F2', fontSize: windowWidth*0.042,fontFamily: 'Inter-Black'}} >Cursos Livres e Profissionalizantes</Text></Body>
  </ListItem>
  <ListItem  icon onPress={() => this.props.navigation.navigate('Ensino fundamental e medio')}>
    <Left><FontAwesome5 name="eye" size={windowWidth*0.045} color='#FCAD02' /></Left>
    <Body ><Text style={{color: '#F0F0F2', fontSize: windowWidth*0.042,fontFamily: 'Inter-Black'}} >Ensino  fundamental e médio</Text></Body>
  </ListItem>
  ...
  <ListItem icon onPress={() => this.props.navigation.navigate('Celulares')}>
    <Left><FontAwesome5 name="eye" size={windowWidth*0.045} color='#FCAD02'/></Left>
    <Body><Text  style={{color: '#F0F0F2', fontSize: windowWidth*0.042,fontFamily: 'Inter-Black'}}>Celulares</Text></Body>
  </ListItem>
  <ListItem icon onPress={() => this.props.navigation.navigate('informaticaeeletronica')}>
    <Left><FontAwesome5 name="eye" size={windowWidth*0.045} color='#FCAD02' /></Left>
    <Body><Text  style={{color: '#F0F0F2', fontSize: windowWidth*0.042,fontFamily: 'Inter-Black'}}>CPUs e Notebooks</Text></Body>
  </ListItem>
  ...
  <ListItem icon onPress={() => this.props.navigation.navigate('redeinternet')}>
    <Left><FontAwesome5 name="eye" size={windowWidth*0.045} color='#FCAD02'/></Left>
    <Body><Text  style={{color: '#F0F0F2', fontSize: windowWidth*0.042,fontFamily: 'Inter-Black'}}>Internet / Comunicação</Text></Body>
  </ListItem>
  <ListItem icon onPress={() => this.props.navigation.navigate('Refrigeração e Assistencia Técnica')}>
    <Left><FontAwesome5 name="eye" size={windowWidth*0.045} color='#FCAD02'/></Left>
    <Body><Text  style={{color: '#F0F0F2', fontSize: windowWidth*0.042,fontFamily: 'Inter-Black'}}>Refrigeração e Assistencia Técnica</Text></Body>
  </ListItem>
  ...
  <ListItem  icon onPress={() => this.props.navigation.navigate('Cabelo e Barba')}>
    <Left><FontAwesome5 name="eye" size={windowWidth*0.045} color='#FCAD02' /></Left>
    <Body ><Text style={{color: '#F0F0F2', fontSize: windowWidth*0.042,fontFamily: 'Inter-Black'}} >Cabelo e Barba</Text></Body>
  </ListItem>
  ...
  <ListItem  icon onPress={() => this.props.navigation.navigate('Chaveiros e Carimbos')}>
    <Left><FontAwesome5 name="eye" size={windowWidth*0.045} color='#FCAD02' /></Left>
    <Body ><Text style={{color: '#F0F0F2', fontSize: windowWidth*0.042,fontFamily: 'Inter-Black'}} >Chaveiros e Carimbos</Text></Body>
  </ListItem>
  <ListItem  icon onPress={() => this.props.navigation.navigate('Serviços Funerários')}>
    <Left><FontAwesome5 name="eye" size={windowWidth*0.045} color='#FCAD02' /></Left>
    <Body ><Text style={{color: '#F0F0F2', fontSize: windowWidth*0.042,fontFamily: 'Inter-Black'}} >Serviços Funerários</Text></Body>
  </ListItem>
  <ListItem  icon onPress={() => this.props.navigation.navigate('Viagens Turismo e Transporte')}>
    <Left><FontAwesome5 name="eye" size={windowWidth*0.045} color='#FCAD02' /></Left>
    <Body ><Text style={{color: '#F0F0F2', fontSize: windowWidth*0.042,fontFamily: 'Inter-Black'}} >Viagens Turismo e Transporte</Text></Body>
  </ListItem>
  <ListItem  icon onPress={() => this.props.navigation.navigate('Comunicação Visual e Fotografia')}>
    <Left><FontAwesome5 name="eye" size={windowWidth*0.045} color='#FCAD02' /></Left>
    <Body ><Text style={{color: '#F0F0F2', fontSize: windowWidth*0.042,fontFamily: 'Inter-Black'}} >Comunicação Visual e Fotografia</Text></Body>
  </ListItem>
